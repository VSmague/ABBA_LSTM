...
from utils.data_handler import create_lagged_series
...
def train_model(
    ...
    X_train, y_train = create_lagged_series(train_series, lag)
    X_val, y_val = create_lagged_series(val_series, lag)
